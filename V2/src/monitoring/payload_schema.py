...
PAYLOAD_SCHEMA: dict[str, tuple[FieldDecision, str | None]] = {
    ...
    'alerts[].details.top_list[].direction':                                            (R, None),  # ex: 'positive' | 'negative' | 'neutral' | 'uncertain' | 'insufficient_data' | None — vem do audience_direction_map.json (ver docs/interno/METODOLOGIA_TOP5_ROAS.md)
    ...
    # challenger_variant — bucket Challenger reavaliado na régua PRÓPRIA do braço A/B
    # (jul_24), não na régua única abr_28. Pode vir None (braço não configurado) → só a
    # leaf aparece; audit exige a declaração, não a presença.
    'lead_quality_metrics.decil_distribution_previous_day.challenger_variant':                 (R, None),
    'lead_quality_metrics.decil_distribution_previous_day.challenger_variant.run_id':          (R, None),
    'lead_quality_metrics.decil_distribution_previous_day.challenger_variant.total':           (R, None),
    'lead_quality_metrics.decil_distribution_previous_day.challenger_variant.distribution':    (R, None),
    'lead_quality_metrics.decil_distribution_previous_day.challenger_variant.distribution.D01': (R, None),
    'lead_quality_metrics.decil_distribution_previous_day.challenger_variant.distribution.D02': (R, None),
    'lead_quality_metrics.decil_distribution_previous_day.challenger_variant.distribution.D03': (R, None),
    'lead_quality_metrics.decil_distribution_previous_day.challenger_variant.distribution.D04': (R, None),
    'lead_quality_metrics.decil_distribution_previous_day.challenger_variant.distribution.D05': (R, None),
    'lead_quality_metrics.decil_distribution_previous_day.challenger_variant.distribution.D06': (R, None),
    'lead_quality_metrics.decil_distribution_previous_day.challenger_variant.distribution.D07': (R, None),
    'lead_quality_metrics.decil_distribution_previous_day.challenger_variant.distribution.D08': (R, None),
    'lead_quality_metrics.decil_distribution_previous_day.challenger_variant.distribution.D09': (R, None),
    'lead_quality_metrics.decil_distribution_previous_day.challenger_variant.distribution.D10': (R, None),
    'lead_quality_metrics.decil_distribution_previous_day.challenger_variant.baseline':        (R, None),
    'lead_quality_metrics.decil_distribution_previous_day.challenger_variant.baseline.pct':    (R, None),
    'lead_quality_metrics.decil_distribution_previous_day.challenger_variant.baseline.pct.D01': (R, None),
    'lead_quality_metrics.decil_distribution_previous_day.challenger_variant.baseline.pct.D02': (R, None),
    'lead_quality_metrics.decil_distribution_previous_day.challenger_variant.baseline.pct.D03': (R, None),
    'lead_quality_metrics.decil_distribution_previous_day.challenger_variant.baseline.pct.D04': (R, None),
    'lead_quality_metrics.decil_distribution_previous_day.challenger_variant.baseline.pct.D05': (R, None),
    'lead_quality_metrics.decil_distribution_previous_day.challenger_variant.baseline.pct.D06': (R, None),
    'lead_quality_metrics.decil_distribution_previous_day.challenger_variant.baseline.pct.D07': (R, None),
    'lead_quality_metrics.decil_distribution_previous_day.challenger_variant.baseline.pct.D08': (R, None),
    'lead_quality_metrics.decil_distribution_previous_day.challenger_variant.baseline.pct.D09': (R, None),
    'lead_quality_metrics.decil_distribution_previous_day.challenger_variant.baseline.pct.D10': (R, None),
    'lead_quality_metrics.decil_distribution_previous_day.challenger_variant.baseline.n_leads': (R, None),
    'lead_quality_metrics.decil_distribution_previous_day.challenger_variant.baseline.label':  (R, None),
    ...
    # (jul_24), não na régua única abr_28. Pode vir None (braço não configurado) → só a
    # leaf aparece; audit exige a declaração, não a presença.
    'lead_quality_metrics.decil_distribution_current_launch.challenger_variant':               (R, None),
    'lead_quality_metrics.decil_distribution_current_launch.challenger_variant.run_id':        (R, None),
    'lead_quality_metrics.decil_distribution_current_launch.challenger_variant.total':         (R, None),
    'lead_quality_metrics.decil_distribution_current_launch.challenger_variant.distribution':  (R, None),
    'lead_quality_metrics.decil_distribution_current_launch.challenger_variant.distribution.D01': (R, None),
    'lead_quality_metrics.decil_distribution_current_launch.challenger_variant.distribution.D02': (R, None),
    'lead_quality_metrics.decil_distribution_current_launch.challenger_variant.distribution.D03': (R, None),
    'lead_quality_metrics.decil_distribution_current_launch.challenger_variant.distribution.D04': (R, None),
    'lead_quality_metrics.decil_distribution_current_launch.challenger_variant.distribution.D05': (R, None),
    'lead_quality_metrics.decil_distribution_current_launch.challenger_variant.distribution.D06': (R, None),
    'lead_quality_metrics.decil_distribution_current_launch.challenger_variant.distribution.D07': (R, None),
    'lead_quality_metrics.decil_distribution_current_launch.challenger_variant.distribution.D08': (R, None),
    'lead_quality_metrics.decil_distribution_current_launch.challenger_variant.distribution.D09': (R, None),
    'lead_quality_metrics.decil_distribution_current_launch.challenger_variant.distribution.D10': (R, None),
    'lead_quality_metrics.decil_distribution_current_launch.challenger_variant.baseline':      (R, None),
    'lead_quality_metrics.decil_distribution_current_launch.challenger_variant.baseline.pct':  (R, None),
    'lead_quality_metrics.decil_distribution_current_launch.challenger_variant.baseline.pct.D01': (R, None),
    'lead_quality_metrics.decil_distribution_current_launch.challenger_variant.baseline.pct.D02': (R, None),
    'lead_quality_metrics.decil_distribution_current_launch.challenger_variant.baseline.pct.D03': (R, None),
    'lead_quality_metrics.decil_distribution_current_launch.challenger_variant.baseline.pct.D04': (R, None),
    'lead_quality_metrics.decil_distribution_current_launch.challenger_variant.baseline.pct.D05': (R, None),
    'lead_quality_metrics.decil_distribution_current_launch.challenger_variant.baseline.pct.D06': (R, None),
    'lead_quality_metrics.decil_distribution_current_launch.challenger_variant.baseline.pct.D07': (R, None),
    'lead_quality_metrics.decil_distribution_current_launch.challenger_variant.baseline.pct.D08': (R, None),
    'lead_quality_metrics.decil_distribution_current_launch.challenger_variant.baseline.pct.D09': (R, None),
    'lead_quality_metrics.decil_distribution_current_launch.challenger_variant.baseline.pct.D10': (R, None),
    'lead_quality_metrics.decil_distribution_current_launch.challenger_variant.baseline.n_leads': (R, None),
    'lead_quality_metrics.decil_distribution_current_launch.challenger_variant.baseline.label': (R, None),
    ...
    'revenue_forecast.expected_conversion.por_variante':                                (S, 'breakdown Champion/Challenger; integrado ao cenário ML-aware'),
    'revenue_forecast.expected_conversion.por_variante[].variant':                      (S, 'breakdown Champion/Challenger; integrado ao cenário ML-aware'),
    'revenue_forecast.expected_conversion.por_variante[].leads':                        (S, 'breakdown Champion/Challenger; integrado ao cenário ML-aware'),
    'revenue_forecast.expected_conversion.por_variante[].benchmark_proprio':            (S, 'breakdown Champion/Challenger; integrado ao cenário ML-aware'),
    'revenue_forecast.inputs':                                                          (R, None),  # ex: dict(10)
    'revenue_forecast.inputs.base_leads':                                               (S, 'detalhes da metodologia no payload da API'),
    ...
    'revenue_forecast.lf_anterior.expected_conversion.por_variante':                    (S, 'breakdown Champion/Challenger; integrado ao cenário ML-aware'),
    'revenue_forecast.lf_anterior.expected_conversion.por_variante[].variant':          (S, 'breakdown Champion/Challenger; integrado ao cenário ML-aware'),
    'revenue_forecast.lf_anterior.expected_conversion.por_variante[].leads':            (S, 'breakdown Champion/Challenger; integrado ao cenário ML-aware'),
    'revenue_forecast.lf_anterior.expected_conversion.por_variante[].benchmark_proprio': (S, 'breakdown Champion/Challenger; integrado ao cenário ML-aware'),
    'revenue_forecast.lf_anterior.inputs':                                              (R, None),
    'revenue_forecast.lf_anterior.inputs.base_leads':                                   (S, 'detalhes da metodologia no payload da API'),
