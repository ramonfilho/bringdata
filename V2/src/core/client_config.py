...
class MetaAudiencesConfig:
    ...
    captacoes_audience_id: Optional[str] = None    # id do público de TODAS as captações (analytics.captacoes ~500k — universo bruto de leads captados, respondente OU não)
