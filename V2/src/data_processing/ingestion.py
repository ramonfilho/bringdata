    ...
    try:
        ...
        try:
            ...
            if not sheets_df.empty:
                ...
                sheets_formatted['genero'] = sheets_df.get('genero', None)
                sheets_formatted['idade'] = sheets_df.get('idade', None)
                sheets_formatted['o_que_faz_atualmente'] = sheets_df.get('ocupacao', None)
                sheets_formatted['Atualmente, qual a sua faixa salar'] = sheets_df.get('faixa_salarial', None)
                sheets_formatted['tem_cartao_credito'] = sheets_df.get('cartao_credito', None)
                sheets_formatted['o_que_quer_ver_evento'] = sheets_df.get('interesse_evento', None)
                sheets_formatted['tem_computador'] = sheets_df.get('tem_computador', None)
                sheets_formatted['estudou_programacao'] = sheets_df.get('estudou_programacao', None)
                sheets_formatted['fez_faculdade'] = sheets_df.get('pretende_faculdade', None)
