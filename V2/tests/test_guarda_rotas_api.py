...
ROTAS_QUE_DEVEM_FICAR_ABERTAS = {
    ...
    '/monitoring/utm-quality': 'front do cliente, ver docs/interno/integracao_front_relatorio_criativo.md',
    '/monitoring/audience-quality': 'front do cliente, ver docs/interno/integracao_front_qualidade_publico.md',
