...
**Status:** ativo. Criado em 2026-06-07. Bloco A em execução (canary `smart-ads-api-00680-jez` 0% tráfego em 2026-06-07); blocos B-F em backlog até priorização pelo `PLANO_EXECUCAO`.
